...
urlpatterns = [
    ...
    path('admin-custom/products/add-attribute/', add_product_attribute, name='add-product-attribute'),
    path('admin-custom/products/<int:pk>/edit-attribute/', edit_product_attribute, name='edit-attribute'),
    path('admin-custom/products/<int:pk>/delete-attribute/', delete_product_attribute, name='delete-attribute'),
    # Admin Category URL
